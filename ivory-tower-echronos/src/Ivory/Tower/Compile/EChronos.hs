...
module Ivory.Tower.Compile.EChronos
  ( compile
  , os
  , searchDir
  ) where
...
import Ivory.Tower.Compile.EChronos.Schedule

import Ivory.Tower.Compile.EChronos.SearchDir
...
-- ivory-echronos-wrapper

commprim_headers :: [FilePath]
commprim_headers =
  [ "echronos_semaphore_wrapper.h"
  , "echronos_task_wrapper.h"
  , "echronos_atomic_wrapper.h"
  ]

commprim_sources :: [FilePath]
commprim_sources =
  [ "echronos_semaphore_wrapper.c"
  , "echronos_task_wrapper.c"
  , "echronos_atomic_wrapper.c"
  ]
